			...
			<view class="cu-bar bg-white justify-end"><view class="content">请输入输赢信息</view></view>
				...
				<view class="cu-form-group margin-top">
					...
					<picker @change="PickerChange" :value="index" :range="picker">
						<view class="picker">{{ index > -1 ? picker[index] : picker[0] }}</view>
					</picker>
				</view>
				<view class="cu-form-group">
					<view class="title">娱乐场所</view>
					<input style="text-align:left" type="text" name="address" :value="address" @input="inputAddress" />
				</view>
				<view class="cu-form-group">
				...
				<view class="cu-form-group flex">
					...
					<view class="flex-sub  cu-tag " :class="Wintype == 2 ? '' : 'cu-tag bg-orange'" @click="ChangeType(1)">略有所得</view>
					<view class="flex-sub  cu-tag " :class="Wintype == 1 ? '' : 'cu-tag bg-orange'" @click="ChangeType(2)">少输当赢</view>
				</view>

				<view class="cu-form-group">
					<view class="title">涉及金额</view>
					<input style="text-align:right" type="number" name="Money" :value="money" @input="inputMoney" />
				</view>
				<view class="cu-form-group">
...
export default {
	...
	methods: {
		...
		go_save_list(e) {
			...
			this.friend1 = (this.friend1 == null || this.friend1 == undefined || this.friend1 == '') ?"未填写":this.friend1
			this.friend2 =(this.friend2 == null || this.friend2 == undefined || this.friend2 == '')?"未填写":this.friend2
			this.friend3 =(this.friend3 == null || this.friend3 == undefined || this.friend3 == '')?"未填写":this.friend3
			this.friend4 =(this.friend4 == null || this.friend4 == undefined || this.friend4 == '')?"未填写"	:this.friend4	
